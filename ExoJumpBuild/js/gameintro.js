const texts = [
    ...
    {
        content: "However, the journey to the Hot Jupiter is fraught with dangers... You will need to demonstrate your piloting skills and dodge these obstacles to reach your destination. Each meteorite you avoid will bring you closer to your goal and allow you to collect data that could change the course of the future.",
...
document.body.addEventListener('click', function() {
    if (currentIndex < texts.length - 1) {
        ...
        window.location.href = "game.html"; // Cambia "index.html" por el nombre de tu archivo HTML al final
    }
});
