...
const quizdata=[
      {
        question:"What are Hot Jupiter exoplanets?",
        options:["Planets that are close to their sun.", "Very small planets", "Planets that are not in the solar system"],
        answer:"Planets that are very close to their sun.",
      },
      {
        question:"What was the first exoplanet discovered among those shown?",
        options:["WASP 16b", "HAT P 12b", "HD209458b", "HD189733b"],
        answer:"HD209458b",
      },
      {
        question:"What is the exoplanet farthest from Earth?",
        options:["Wasp 31b", "WASP 17b", "WASP 19b", "WASP 39b"],
        answer:"WASP 17b",
      },
      {
        question:"Which is the most massive planet among those shown?",
        options:["HAT P 1b", "WASP 19b", "HD209458", "WASP 17b"],
        answer:"WASP 19b",
      },
      {
        question:"What planet orbits a K-type star?",
        options:["HAT 12b", "WASP 17b", "HD209458b", "HD189733b"],
        answer:"HAT 12b",
      },
      {
        question:"What exoplanets were discovered using the radial velocity method?",
        options:["WASP exoplanets", "HAT exoplanets", "HD exoplanets", "All the previous answers."],
        answer:"HD exoplanets",
      },
      {
        question:"Which exoplanet is the largest?",
        options:["WASP 17b", "HAT P 12b", "WASP 31b", "HAT P 1b"],
        answer:"WASP 17b",
      },
      {
        question:"Regarding the earth, how hot are the Hot Jupiters?",
        options:["Hotter than Earth", "Less hot than Earth", "Equally hot as Earth", "None of the above"],
        answer:"Hotter than Earth",
      },
      {
        question:"What type of planets are Hot Jupiters?",
        options:["Solids", "Liquids", "Gases", "None of the above"],
        answer:"Gases",
      },
      {
        question:"Which exoplanet is the smallest?",
        options:["HAT P 1b", "WASP 39b", "HAT P 12b", "WASP 31b"],
        answer:"HAT P 12b",
      },
      {
        question:"Which planet takes the least time to complete its orbit?",
        options:["HAT P 1b", "WASP 17b", "WASP 39b", "WASP 19b"],
        answer:"WASP 19b",
      },
      {
        question:"What is the closest planet to Earth?",
        options:["WASP 39b", "WASP 19b", "HD 189733", "HAT P 1b"],
        answer:"HD 189733",
      },
    ];
